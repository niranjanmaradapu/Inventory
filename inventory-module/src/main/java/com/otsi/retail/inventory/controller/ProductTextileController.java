...
public class ProductTextileController {
	...
	@ApiResponses(value = { @ApiResponse(code = 500, message = "Server error"),
			@ApiResponse(code = 200, message = "Successful retrieval", response = ProductTextileVo.class, responseContainer = "Object") })
	...
	@ApiOperation(value = "getAllAdjustments", notes = "fetch rebarcodes for the textile ", response = AdjustmentsVo.class)
	@ApiResponses(value = { @ApiResponse(code = 500, message = "Server error"),
	...
	public GateWayResponse<?> getAllAdjustments(Pageable pageable, @RequestBody SearchFilterVo vo) {
		log.info("Recieved request to getAllAdjustments:" + vo);
		Page<AdjustmentsVo> allBarcodes = productTextileService.getAllAdjustments(vo, pageable);
	...
	public GateWayResponse<?> getBarcodeTextileReports(@RequestBody SearchFilterVo vo, Pageable pageable) {
		...
		Page<ProductTextileVo> allBarcodes = productTextileService.getBarcodeTextileReports(vo, pageable);
		return new GateWayResponse<>("fetching all barcode textile details sucessfully", allBarcodes);
	}
